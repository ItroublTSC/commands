  module.exports.run = async (bot, message, args) => {
    ...
    if(message.member.hasPermission("Manage Messages")) {     ///To allow a simple moderator to use the command just put MANAGE_MESSAGES in place of ADMINISTRATOR 
      ...
      return message.reply(":x: " + "| You need to be \"Manage Messages\" to do that")
    }
    }
